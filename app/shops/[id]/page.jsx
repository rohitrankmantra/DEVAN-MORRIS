// app/shop/[id]/page.jsx (Full Detail Page - Dynamic from data/products.js)
"use client";
      ...
      <section className="pt-28 pb-4 bg-linear-to-b from-[#D5CE95]/10 to-transparent">
        <div className="container mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link href="/shop" className="text-muted-foreground hover:text-[#D5CE95] transition-colors">
              Shop
            </Link>
            <ChevronRight className="w-4 h-4 text-muted-foreground" />
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-linear-to-br from-[#D5CE95] to-[#C4B87A] flex items-center justify-center text-charcoal font-medium">
                            {review.name[0]}
                          </div>
                          <div>
                ...
                <Link href={`/shop/${rel.id}`}>
                  <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#D5CE95]/10 hover:shadow-xl hover:border-[#D5CE95]/30 transition-all duration-500">
                    <div className="relative aspect-square overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-linear-to-t from-charcoal/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
